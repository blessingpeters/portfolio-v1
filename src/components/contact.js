        ...
        <article className="py-6 my-8 md:grid md:grid-cols-2 gap-x-8">
          ...
          <article className="self-center text-center md:text-left">
            <p className="mb-3 text-base md:leading-7 md:text-lg text-custom-purple">
              I’m currently open to new opportunities and requests – freelance
              work, collaborations and partnership opportunities .
              <br />
            </p>
            <p className="mb-5 text-base md:leading-7 md:text-lg text-custom-purple ">
              ...
              experience, questions, or just want to say hi, then don’t hesitate
              to contact me.
            </p>
            <a href="mailto:cherubpeters.com">
              <button
                type="button"
                className="border border-solid border-black font-semibold bg-transparent cursor-pointer rounded-sm px-5 py-3.5   hover:text-yellow-600 hover:border-yellow-600"
